...
} KEY_InitStruct[KEY_NUM] =
{
  ...
  {KEY4_GPIO_PORT,KEY4_GPIO_PIN,KEY4_GPIO_CONFIG,KEY4_PRESSED_LEVEL}, //按键4引脚配置参数
  {KEY5_GPIO_PORT,KEY5_GPIO_PIN,KEY5_GPIO_CONFIG,KEY5_PRESSED_LEVEL}, //按键5引脚配置参数
  {KEY6_GPIO_PORT,KEY6_GPIO_PIN,KEY6_GPIO_CONFIG,KEY6_PRESSED_LEVEL}, //按键6引脚配置参数
};
//按键处理信息变量
volatile struct
{
