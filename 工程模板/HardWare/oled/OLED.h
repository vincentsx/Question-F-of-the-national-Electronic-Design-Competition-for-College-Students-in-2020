...
#define OLED_SCL_PIN    3       //D0 时钟

#define OLED_SDA_PORT   P4
#define OLED_SDA_PIN    0       //D1 数据

#define OLED_SCL    PIN_OUT(OLED_SCL_PORT,OLED_SCL_PIN)        //P4.3
#define OLED_SDA    PIN_OUT(OLED_SDA_PORT,OLED_SDA_PIN)        //P4.0
#endif
...
#define OLED_RST    PIN_OUT(OLED_RST_PORT,OLED_RST_PIN)       //P3.7
#define OLED_DC     PIN_OUT(OLED_DC_PORT,OLED_DC_PIN)         //P8.2
